 ...
 * {@link TagWordLattice}, which itself implements {@link TagLattice};
...
public class HmmDecoder 
     ...
     * @deprecated Use {@link #tagMarginal(List)} instead.
     */
    @Deprecated
     ...
     * specified strings.
     * @deprecated Use {@link #tag(List)} instead.
     */
    @Deprecated
     ...
     * of likelihood.
     * @deprecated Use {@link #tagNBest(List,int)} instead.
     */
    @Deprecated
     ...
     * @return Iterator over scored tag sequences in decreasing order
     * of likelihood.
     * @deprecated Use {@link #tagNBestConditional(List,int)} instead.
     */
    @Deprecated
