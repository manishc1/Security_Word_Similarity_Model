 ...
 * href="http://nltk.sourceforge.net/index.php/Main_Page">Natural Language Toolkit</a>
 * (NLTK) distribution of the <a
 * href="http://icame.uib.no/brown/bcm.html">Brown
 * Corpus</a>.  The results may be consumed by a text
 * handler.
 *
...
public class BrownTextParser extends StringParser<TextHandler> {
    ...
    public void parseString(char[] cs, int start, int end) throws IOException {
        TextHandler handler = getHandler();
