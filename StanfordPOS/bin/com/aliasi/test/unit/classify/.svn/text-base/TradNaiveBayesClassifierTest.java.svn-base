...
public class TradNaiveBayesClassifierTest {
    ...
    public void testUnknownCatTrainException() {
        TradNaiveBayesClassifier classifier
            = new TradNaiveBayesClassifier(CAT_SET_2,TOKENIZER_FACTORY,
                                           1,1,1);
        classifier.handle("any old string",
    ...
    public void knownTokenTest() {
        TradNaiveBayesClassifier classifier
            = new TradNaiveBayesClassifier(CAT_SET_2,TOKENIZER_FACTORY,
                                           1,1,1);
        classifier.handle("john ran",new Classification("a"));
    ...
    public void log2CaseProbTest() {
        TradNaiveBayesClassifier classifier
            = new TradNaiveBayesClassifier(CAT_SET_2,TOKENIZER_FACTORY,
                                           1,1,Double.NaN);
        classifier.handle("john ran",new Classification("a"));
        classifier.handle("john jumped", new Classification("a"));
        classifier.handle("mary ran", new Classification("b"));
        classifier.handle("run, mary, run", new Classification("b"));
    ...
    */
    ...
    public void testProbCat() throws IOException {
        ...
        classifier.handle("john ran",new Classification("a"));
        classifier.handle("john jumped", new Classification("a"));
        classifier.handle("john ran and jumped", new Classification("a"));
        classifier.handle("mary ran", new Classification("b"));
        classifier.handle("run, mary, run", new Classification("b"));
    ...
    public void testClassification() {
        ...
        classifier.handle("mary ran", new Classification("b"));
        classifier.handle("run, mary, run", new Classification("b"));
        classifier.handle("mary run", new Classification("b"));
    ...
    public void testClassificationCompile() throws ClassNotFoundException, IOException {
        ...
        Classifier<CharSequence,ConditionalClassification> classifier2
            = (Classifier<CharSequence,ConditionalClassification>)
    ...
    public void testLengthNorm() throws IOException, ClassNotFoundException {
        ...
        Classifier<CharSequence,ConditionalClassification> classifierSer
            = (Classifier<CharSequence,ConditionalClassification>)
            AbstractExternalizable.serializeDeserialize(classifier);

        Classifier<CharSequence,ConditionalClassification> classifierComp
            = (Classifier<CharSequence,ConditionalClassification>)
            AbstractExternalizable.compile(classifier);
    ...
    public void testLengthNormTernary() throws IOException, ClassNotFoundException {
        ...
        classifier.handle("run, mary, run", new Classification("b"));
        classifier.handle("mary run", new Classification("b"));
        classifier.handle("bill ran", new Classification("c"));
