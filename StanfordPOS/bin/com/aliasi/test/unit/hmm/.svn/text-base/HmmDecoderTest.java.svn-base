...
public class HmmDecoderTest  {
	...
	assertArrayEquals(empty, decoder.firstBest(empty));

	for (int i = 0; i < 5; ++i)
	    assertArrayEquals(empty, decoderCached.firstBest(empty));
