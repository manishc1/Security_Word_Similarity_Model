...
public class TokenizedLM
    ...
    /**
     * See {@link #collocationSet(int,int,int)}.
     *
     ...
     * @deprecated Use {@link #collocationSet(int,int,int)} instead.
     */
    @Deprecated
    ...
    /**
     * See {@link #newTermSet(int,int,int,LanguageModel.Tokenized)}.
     *
     ...
     * @deprecated Use {@link #newTermSet(int,int,int,LanguageModel.Tokenized)}
     * instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #oldTermSet(int,int,int,LanguageModel.Tokenized)} instead.
     */
    @Deprecated
    ...
    /**
     * See {@link #frequentTermSet(int,int)}.
     *
     * @param nGram Length of n-grams to search.
     * @param maxReturned Maximum number of results returned.
     * @deprecated Use {@link #frequentTermSet(int,int)} instead.
     */
    @Deprecated
    ...
    /**
     * See {@link #infrequentTermSet(int,int)}.
     *
     * @param nGram Length of n-grams to search.
     * @param maxReturned Maximum number of results returned.
     * @deprecated Use {@link #infrequentTermSet(int,int)} instead.
     */
    @Deprecated
