...
public class Article {
     ...
     *
     * <blockquote>
     * <a href="http://www.ncbi.nlm.nih.gov/entrez/query/static/help/pmhelp.html">PubMed Help: Publication Types</a>
     * </blockquote>
     *
    ...
    static class Handler extends DelegateHandler {
        ...
        public Article getArticle() {
            String[] languages = mLanguageList.<String>toArray(Strings.EMPTY_STRING_ARRAY);
            String[] publicationTypes = mPublicationTypeList.toArray(Strings.EMPTY_STRING_ARRAY);
            ELocationId[] eLocationIds
                = mELocationIdList.<ELocationId>toArray(EMPTY_E_LOCATION_ID_ARRAY);
