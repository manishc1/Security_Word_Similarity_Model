...
public class KeywordList implements Iterable<Topic> {
    ...
    public Iterator<Topic> iterator() {
        return Iterators.<Topic>array(mKeywords);
    }
    ...
    static class Handler extends DelegateHandler {
        ...
        private final List<Topic> mKeywordList = new ArrayList<Topic>();
        ...
        public KeywordList getKeywordList() {
            ...
            Topic[] keywords = mKeywordList.<Topic>toArray(MeshHeading.EMPTY_TOPIC_ARRAY);
