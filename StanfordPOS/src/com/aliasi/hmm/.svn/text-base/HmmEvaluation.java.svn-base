...
public class HmmEvaluation {
    ...
    private final Set<String> mKnownTokenSet
        = new HashSet<String>();
    ...
    public Set<String> knownTokenSet() {
        return Collections.<String>unmodifiableSet(mKnownTokenSet);
    }
    ...
    public void addNBestCase(String[] tokens,
        ...
        for (int i = 0; ((i < mMaxNBest) && nBestIterator.hasNext()); ++i) {
            ...
            String[] responseTags = response.getObject();
            if (com.aliasi.util.Arrays.equals(referenceTags,responseTags)) {
                mNBestHistogram.increment(Integer.valueOf(i));
                mLastNBest = i;
                return;
            }
        }
        mLastNBest = mMaxNBest;
        mNBestHistogram.increment(Integer.valueOf(mMaxNBest));
    }
    ...
    public String toString() {
        ...
        sb.append("#Cases=" + mNumCases);
        sb.append("\n  #Toks=" + mNumTokens);
        sb.append("\n  Tok Acc=");
        formatter.format("%5.3f",mFirstBestEvaluation.confusionMatrix().totalAccuracy());
        sb.append("\n  Case Acc=");
        formatter.format("%5.3f",caseAccuracy());
        sb.append("\n  Lattice Acc=");
        formatter.format("%5.3f",mLatticeEvaluation.confusionMatrix().totalAccuracy());
        sb.append("\n  Unknown Toks=" + mNumUnknownTokens);
        sb.append("\n  Unknown Tok Acc=");
        formatter.format("%5.3f",unknownTokenAccuracy());
        return sb.toString();
    }
