 ...
 * @version 3.9
 * @since   LingPipe2.1
 * @deprecated Use {@link TagLattice} interface for return results, and
 * {@link com.aliasi.crf.ForwardBackwardTagLattice} for construction.
 */
@Deprecated
public class TagWordLattice extends TagLattice<String> {
     ...
     * @deprecated Use {@link #log2ConditionalTagList(int)} instead.
     */
    @Deprecated
