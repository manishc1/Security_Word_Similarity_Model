...
public class ObjectToDoubleMap<E> extends HashMap<E,Double> {
     ...
     * @deprecated Use {@link #keysOrderedByValueList()} instead.
     */
    @Deprecated
     ...
     * @deprecated  Use {@link #scoredObjectsOrderedByValueList()} instead.
     */
    @Deprecated
    public ScoredObject<E>[] scoredObjectsOrderedByValue() {
        ...
        java.util.Arrays.sort(result,ScoredObject.reverseComparator());
        return result;
    }
