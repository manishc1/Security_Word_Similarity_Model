 ...
 * @version 3.8
 * @since   LingPipe2.0
 * @param <E> the type of objects stored in the n-best set
 * @deprecated Use {@link BoundedPriorityQueue} or {@link ShortPriorityQueue}
 * instead.
 */
@Deprecated
public class NBestSet<E> extends TreeSet<E> {
    ...
    public boolean add(E obj) {
        ...
        E first = first();
        int comparison = Collections.<E>compare(obj,first,comparator());
