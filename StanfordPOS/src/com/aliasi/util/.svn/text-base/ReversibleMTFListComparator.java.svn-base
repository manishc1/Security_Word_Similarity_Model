 ...
 * @deprecated We'll put this in a demo if we ever need to build
...
public class ReversibleMTFListComparator<E> implements Comparator<E> {
     ...
     * @deprecated This class is going away in LingPipe 4.0.
     */
    @Deprecated
    @SuppressWarnings("deprecated")
    private final Map<Comparator<? super E>,ReversibleComparator<? super E>>
        mComparatorToReversibleComparator
        = new HashMap<Comparator<? super E>,ReversibleComparator<? super E>>();
     ...
     */
    @Deprecated
    private ReversibleComparator<? super E>
        getReversibleComparator(Comparator<? super E> comparator) {
    ...
    public int compare(E obj1, E obj2) {
        for (Comparator<? super E> comparator : mComparatorList) {
