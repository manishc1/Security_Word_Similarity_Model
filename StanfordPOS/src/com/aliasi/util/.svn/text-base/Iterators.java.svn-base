...
public class Iterators {
     ...
     * @deprecated Construct with the static factory method {@link
     * #array(Object[])} instead.
     */
    @Deprecated
    public static class Array<E> implements Iterator<E> {
         ...
         * @deprecated Use the static factory method {@link
         * #array(Object[])} instead.
         */
        @Deprecated
     ...
     * @param <E> the type of objects returned by the iterator
     * @deprecated Use the static factory method {@link
     * #arraySlice(Object[],int,int)} instead.
     */
    @Deprecated
     ...
     * @since   LingPipe3.0
     * @param <E> the type of objects returned by the iterator
     * @deprecated Use the static factory method {@link #empty()} instead.
     */
    @Deprecated
     ...
     * @since   LingPipe2.0
     * @param <E> the type of objects returned by the iterator
     * @deprecated Use the static factory method {@link #singleton(Object)}
     * instead.
     */
    @Deprecated
     ...
     * @since   LingPipe2.0
     * @param <E> the type of objects returned by the iterator
     * @deprecated Use the static factory method {@link #pair(Object,Object)}
     * instead.
     */
    @Deprecated
     ...
     * @param <E> the type of objects returned by the iterator
     * @deprecated Use the static factory method {@link
     * #sequence(Iterator,Iterator)}, {@link #sequence(Iterator)},
     * or {@link #sequence(List)} instead.
     */
    @Deprecated
    public static class Sequence<E> implements Iterator<E> {
         ...
         * @deprecated Use the static factory method {@link
         * #sequence(Iterator,Iterator)} instead.
         */
        @Deprecated
     ...
     * specified.  The result is very much like {@link Iterators.Array},
     * but as a {@link PrimitiveInt} return for efficient access
