...
public class BoundedPriorityQueue<E>
     ...
     *
     * <p>This method behaves the same way as {@link
     * #add(Object)}.
     *
     * @param e Item offered.
     ...
     * @deprecated Use {@link #poll()} instead.
     */
    @Deprecated
    public E pop() {
        if (isEmpty()) return null;
     ...
     *
     * <p>The current implementation violates the contract of
     * {@link java.util.Collection} by not throwing an exception
     * if the item fails to add.
     *
     * @param o Object to add to queue.
     * @return <code>true</code> if the object was added.
     * @deprecated Use {@link #offer(Object)} instead.  In the next
