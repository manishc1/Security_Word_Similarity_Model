...
public class Strings {
     ...
     * @deprecated Use {@code new String(s)} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@code java.util.Formatter} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@code Integer.toHexString(b)} instead.
     */
    @Deprecated
     ...
     * stream.
     * @deprecated Write your own with {@code
     ...
     * the stream.
     * @deprecated Build this yourself using {@link DataInput#readUTF()}.
     */
    @Deprecated
     ...
     * @deprecated Use {@link java.text.DecimalFormat} directly with a pattern, or use the
     * newer {@link java.util.Formatter} class or {@link String#format(String,Object[])} utility
     * method instead.
    */
    @Deprecated
