 ...
 * {@link #perTokenEvaluation()}, which returns a classifier
...
public class MarginalTaggerEvaluator<E> implements ObjectHandler<Tagging<E>> {
    ...
    private final ClassifierEvaluator<E,ConditionalClassification> mEvaluator;
    ...
    public MarginalTaggerEvaluator(MarginalTagger<E> tagger,
        ...
        mEvaluator = new ClassifierEvaluator<E,ConditionalClassification>(null,tags,storeTokens);
    }
    ...
    public void addCase(Tagging<E> referenceTagging,
        ...
        for (int n = 0; n < tokens.size(); ++n) {
            ...
            mEvaluator.addClassification(referenceTag,responseClassification,token);
        }
    }
     ...
     */
    public ClassifierEvaluator<E,ConditionalClassification> perTokenEvaluation() {
        return mEvaluator;
    }
