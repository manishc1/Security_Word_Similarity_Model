...
public class SeqClassifierFlags implements Serializable {
  ...
  // TODO: [cdm aug06]: this should really be an int now (number of datums
  // for which to write features), but I kept it a String so as not to break
  // serialization.  Change when breaking serialization anyway.
  ...
  public String inputEncoding = null; // used for CTBSegDocumentReader as well
