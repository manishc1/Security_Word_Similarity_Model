...
class TsurgeonParser/*@bgen(jjtree)*/implements TsurgeonParserTreeConstants, TsurgeonParserConstants {/*@bgen(jjtree)*/
  ...
  public static void main(String[] args) {
    ...
    try {
      TsurgeonPattern n = TsurgeonParser.Root();
...
// the argument says whether there must be a foot node on the aux tree.
 ...
 /*@bgen(jjtree) TreeDtrs */
  ...
  static public void ReInit(java.io.InputStream stream, String encoding) {
    ...
    TsurgeonParserTokenManager.ReInit(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
    jj_gen = 0;
  ...
  static final private Token jj_consume_token(int kind) throws ParseException {
    ...
    else token = token.next = TsurgeonParserTokenManager.getNextToken();
    jj_ntk = -1;
    if (token.kind == kind) {
      jj_gen++;
      if (++jj_gc > 100) {
  ...
  static final private boolean jj_scan_token(int kind) {
    if (jj_scanpos == jj_lastpos) {
      ...
      if (jj_scanpos.next == null) {
        jj_lastpos = jj_scanpos = jj_scanpos.next = TsurgeonParserTokenManager.getNextToken();
      } else {
  ...
  static final public Token getToken(int index) {
    ...
    for (int i = 0; i < index; i++) {
      ...
      else t = t.next = TsurgeonParserTokenManager.getNextToken();
    }
    return t;
  }
  ...
  static final private int jj_ntk() {
    if ((jj_nt=token.next) == null)
      return (jj_ntk = (token.next=TsurgeonParserTokenManager.getNextToken()).kind);
    else
