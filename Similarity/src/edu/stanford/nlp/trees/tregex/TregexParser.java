...
// pertains to this node gets passed all the way down to the Description node
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0xcd380,0xc04030,0xc04030,0xcd380,0x4000,0x8000,0x380,0x10000,0x40000,0xc0000,0xc0380,0x100000,0xe04030,0x200000,0xc04030,0x800030,0x40,0x4000,0x380,0x4000,0x5200,0x30,};
   }
  ...
  static final private Token jj_consume_token(int kind) throws ParseException {
    ...
    else token = token.next = TregexParserTokenManager.getNextToken();
    jj_ntk = -1;
    if (token.kind == kind) {
      jj_gen++;
      return token;
  ...
  static final public Token getToken(int index) {
    ...
    for (int i = 0; i < index; i++) {
      ...
      else t = t.next = TregexParserTokenManager.getNextToken();
    }
    return t;
  }
  ...
  static final private int jj_ntk() {
    if ((jj_nt=token.next) == null)
      return (jj_ntk = (token.next=TregexParserTokenManager.getNextToken()).kind);
    else
