...
public class LexicalProcess {
	...
	public static String tokenLocalName(String localname){
	    ...
	    while (matcher.find()){
	    	...
	    	int i;
	    	for (i = temptext.length() -1 ; i >= 0; i--){
	    		if (Character.isUpperCase(temptext.charAt(i)) || temptext.charAt(i) == '.')
	    			break;
	    		//if (!Character.isDigit(temptext.charAt(i)) && !Character.isLowerCase(temptext.charAt(i)) && temptext.charAt(i) != '\'' && temptext.charAt(i) != '-')
	    		//	break;
	    	}
	    	if (i > 0 && i != temptext.length() -1)
	    		temptext = temptext.substring(0, i) + " " + temptext.substring(i);
	    	...
	    	//tokens.add(temptext);
	    	//if (!isAcronym(temptext) && !isAbbreviation(temptext))
	...
	public static boolean isAbbreviation(String word){
		...
		if (Character.isUpperCase(word.charAt(0)) && word.endsWith("."))
			return true;
		else
			return false;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(LexicalProcess.tokenLocalName("U.S.A."));
		...
		System.out.println(LexicalProcess.tokenLocalName("People's Republic of China"));
		//System.out.println(LexicalProcess.tokenDeep("People's Republic of China"));

		System.out.println(LexicalProcess.tokenLocalName("volume No."));
		System.out.println(LexicalProcess.tokenLocalName("volume no."));
		System.out.println(LexicalProcess.tokenLocalName("PhDStudent123"));
		//System.out.println(LexicalProcess.tokenDeep("PhDStudent123"));
		System.out.println(LexicalProcess.tokenLocalName("e-mail"));
		//System.out.println(LexicalProcess.tokenDeep("e-mail"));
		...
		System.out.println(LexicalProcess.isNumber("1/a212"));
	}
