...
public class SimilarityTreeMapModel implements Serializable {
	...
	public static void main(String[] args) throws IOException {
		...
		SimilarityTreeMapModel model = new SimilarityTreeMapModel("/home/lushan1/nlp/model/SVD/Wikipedia2006AllW5");
		
		model.loadInitialSimilarity(gutn, wiki);
		System.out.println("Finished loading!");
		
		SimilarityTreeMapModel.writeModel("/home/lushan1/nlp/model/TreeMap/wiki5", model);
